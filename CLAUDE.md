...
3. **A deployment uses Vertex AI, not the Gemini API key**, and that is a cost
   ...
   where the programme credits are. Three env vars and no code change:
